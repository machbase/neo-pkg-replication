 ...
 *
 * logger.test.js → checkpoint.test.js → client.test.js → table.test.js → mqtt_publish_topic.test.js → replication.test.js 순서로 실행한다.
...
require(TESTS_DIR + '/checkpoint.test.js');
require(TESTS_DIR + '/multidatabase.test.js');
